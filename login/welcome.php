...
<div class="container-fluid">
  <div class="row">
    <div class="page-header1 col-md-12">
      <div class="col-md-3">
        <nav class="nav nav-pills flex-column flex-sm-row">
          <img src="../img/logo.jpeg" class="float-right" id="logoWelcome">
        </nav>
      </div>
      <div class="col-md-3 col-md-offset-1">
        <h3>Bienvenido a SOEF</h3>
      </div>
      <div class="col-md-2 col-md-offset-2">
        <h4>Hola,<?php echo htmlspecialchars($_SESSION["username"]); ?></h4>
        <?php
