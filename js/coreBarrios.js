...
$(document).on("click", ".crudInsertBarrio", function(){
...
$(document).on("click", ".updateBarrio", function() {

	var idBarrio = $(this).attr("id");
...
$(document).on("click", ".crudUpdateBarrio", function(){
